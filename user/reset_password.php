...
if(isset($_POST['submit']))
{
    ...
    // Update query to match tbuser table
    $query = mysqli_query($con, "UPDATE tbuser SET user_password='$password' WHERE user_email='$email' AND user_phone='$contactno' ");
    
    if($query)
    {
        echo "<script>alert('Password successfully changed');</script>";
        echo "<script type='text/javascript'> document.location ='login.php'; </script>";
        session_destroy();  // End the session after password reset
    }
}
?>
<!DOCTYPE html>
