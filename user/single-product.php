        ...
        <div class="grid images_3_of_2">
            <div class="flexslider1">
                <ul class="slides">
                    ...
                    <li data-thumb="uploads/<?php echo $row['Image']; ?>">
                    ...
                    <?php if ($row['Image1']): ?>
                        <li data-thumb="../images/<?php echo $row['Image1']; ?>">
                            <div class="thumb-image">
                                <img src="../images/<?php echo $row['Image1']; ?>" data-imagezoom="true" class="img-fluid" alt="">
                            </div>
                        </li>
                    <?php endif; ?>

                    <?php if ($row['Image2']): ?>
                        <li data-thumb="../images/<?php echo $row['Image2']; ?>">
                            <div class="thumb-image">
                                <img src="../images//<?php echo $row['Image2']; ?>" data-imagezoom="true" class="img-fluid" alt="">
                            </div>
                        </li>
                    <?php endif; ?>

                    <?php if ($row['Image3']): ?>
                        <li data-thumb="../images/<?php echo $row['Image3']; ?>">
                            <div class="thumb-image">
                                <img src="../images/<?php echo $row['Image3']; ?>" data-imagezoom="true" class="img-fluid" alt="">
                            </div>
                        </li>
                    <?php endif; ?>

                    <?php if ($row['Image4']): ?>
                        <li data-thumb="../images/<?php echo $row['Image4']; ?>">
                            <div class="thumb-image">
                                <img src="../images/<?php echo $row['Image4']; ?>" data-imagezoom="true" class="img-fluid" alt="">
                            </div>
                        </li>
                    <?php endif; ?>
                </ul>
