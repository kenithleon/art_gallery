...
if (!isset($_SESSION['user_id'])) {
    ...
    echo '<script>alert("Please log in to make an enquiry."); window.location.href="user/login.php";</script>';
...
if(isset($_POST['send'])) {
    ...
    $query1 = mysqli_query($con, "INSERT INTO tblenquiry(Artpdid, FullName, Email, MobileNumber, Message, EnquiryNumber) VALUES ('$eid', '$fullname', '$email', '$mobilenumber', '$message', '$enquirynumber')");
    
    if ($query1) {
        echo '<script>alert("Your enquiry has been successfully sent. Your Enquiry number is ' . $enquirynumber . '")</script>';
