...
ALTER TABLE tblorder ADD user_name VARCHAR(255);
ALTER TABLE tblorder ADD delivery_address VARCHAR(255);
ALTER TABLE tblorder ADD phone_number VARCHAR(20);
ALTER TABLE tblorder ADD payment_option VARCHAR(50);
ALTER TABLE tblorder ADD delivery_date DATE;
--
...
ALTER TABLE tblartproduct
ADD CONSTRAINT fk_artist FOREIGN KEY (Artist) REFERENCES tblartist(ID);
